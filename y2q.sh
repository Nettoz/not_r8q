...
make O=/home/skye/bomb/out $BUILD_ENV vendor/kona-not_defconfig vendor/samsung/y2q.config vendor/debugfs.config
...
#cat $DTB_OUT/*.dtb > /home/skye/bomb/AnyKernel3/y2q/dtb
...
echo "**Build outputs**"
cp $IMAGE /home/skye/bomb/AnyKernel3/y2q/Image

cd /home/skye/bomb/AnyKernel3/y2q
rm *.zip
