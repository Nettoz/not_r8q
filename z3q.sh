...
make O=/home/skye/bomb/out $BUILD_ENV vendor/kona-not_defconfig vendor/samsung/z3q.config vendor/debugfs.config
...
#cat $DTB_OUT/*.dtb > /home/skye/bomb/AnyKernel3/z3q/dtb
...
echo "**Build outputs**"
cp $IMAGE /home/skye/bomb/AnyKernel3/z3q/Image

cd /home/skye/bomb/AnyKernel3/z3q
rm *.zip
zip -r9 ${KERNEL_NAME}$(date +"%Y%m%d")+z3q.zip .
